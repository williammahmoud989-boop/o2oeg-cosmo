...
<body style="background-color: #050505; color: white;">
    ...
    <nav class="glass" style="position: sticky; top: 0; z-index: 1000; padding: 1rem 0;">
       ...
       <main>
        ...
        <!-- AI Consultant Section - FIXED -->
        <section id="ai-consultant" style="padding: clamp(4rem, 10vw, 8rem) 0; border-top: 1px solid rgba(255,255,255,0.05); position: relative; z-index: 100;">
            <div class="container">
                <div style="text-align: center; margin-bottom: 4rem;">
                    <span style="background: rgba(255, 92, 0, 0.2); color: #FF5C00; padding: 0.6rem 1.5rem; border-radius: 50px; font-weight: 800; font-size: 0.9rem; text-transform: uppercase;">ذكاء اصطناعي سيادي 2026</span>
                    <h2 style="font-size: clamp(2rem, 6vw, 3rem); font-weight: 900; margin: 1.5rem 0; color: white;">خبير التجميل الافتراضي</h2>
                    <p style="color: #94A3B8; font-size: 1.1rem; max-width: 750px; margin: 0 auto;">ارفعي صورة الآن للحصول على استشارة فورية مدعومة بمحرك Gemini.</p>
                </div>

                <div class="ai-scanner-container" style="display: block !important; opacity: 1 !important; visibility: visible !important; background: #0A0A12; border: 1px solid rgba(255,255,255,0.05); border-radius: 3rem; padding: clamp(1.5rem, 5vw, 4rem);">
                    <div class="upload-area" id="uploadArea" style="border: 3px dashed rgba(255, 92, 0, 0.4); padding: 5rem 2rem; border-radius: 2rem; cursor: pointer; text-align: center;">
                        <div id="uploadPlaceholder">
                            <div style="font-size: 4rem; margin-bottom: 1.5rem;">📸</div>
                            <h3 style="color: white; margin-bottom: 0.5rem;">اضغطي هنا لرفع الصورة</h3>
                            <p style="color: #64748B;">يدعم الصور عالية الجودة (JPG, PNG)</p>
                        </div>
                        <div class="preview-container" id="previewContainer" style="display: none; position: relative;">
                            <img id="previewImage" src="" alt="Preview" style="max-width: 100%; border-radius: 1.5rem;">
                            <div class="scanner-line" id="scannerLine" style="height: 4px; background: #FF5C00; position: absolute; width: 100%; top: 0; display: none;"></div>
                        </div>
                        <input type="file" id="imageInput" accept="image/*" style="display: none;">
                    </div>

                    <div style="text-align: center; margin-top: 2rem;">
                        <button id="analyzeBtn" class="btn btn-orange" style="display: none; padding: 1rem 3rem; border-radius: 50px;">ابدأ تحليل Gemini ⚡</button>
                    </div>

                    <div class="ai-result-card" id="aiResultCard" style="display: none; margin-top: 3rem;">
                        <div style="padding: 2.5rem; background: rgba(255, 92, 0, 0.05); border-radius: 2.5rem; border: 1px solid rgba(255, 92, 0, 0.2);">
                            <h3 style="color: white; margin-bottom: 1.5rem;">✨ نتيجة التحليل الرقمي</h3>
                            <div id="aiAnalysisText" style="color: white; line-height: 1.8;"></div>
                            <div style="margin-top: 2rem;">
                                <h4 style="color: #FF5C00; margin-bottom: 1rem;">الخدمات الموصى بها:</h4>
                                <div class="recommendation-chips" id="recommendationChips" style="display: flex; gap: 0.75rem; flex-wrap: wrap;"></div>
                            </div>
                        </div>
                    </div>
                </div>
